    ...
    <v-card class="mb-2">
      <v-card-text class="body-1">
        <p>
          ...
          kisi now supports Canadian dollar funding and withdrawals for
        ...
        <v-card-text>
          ...
          >
            ...
            <p class="body-1">
              ...
              <a href="mailto:compliance@kisi.io">compliance@kisi.io</a> if
          ...
          <v-form v-else>
            ...
            <v-file-input
              ...
              hint="Selfie of you holding up your ID and a piece of paper with the word 'kisi' and today's date written on it"
              persistent-hint
              accept=".pdf,image/*"
              @change="changeProof"
            ...
            <div v-if="method === 'interac'">
              <ol class="mb-2">
                <li>
                  ...
                  <span class="title white--text">funding@kisi.io</span>
                </li>
                <li>
