  ...
  <div>
    <v-card class="mb-2">
      <v-card-text class="white--text body-1">
        <p>
          kisi is an open source bitcoin web wallet. Anyone can
          <a href="https://github.com/asoltys/kisi"
        ...
        <p>
          kisi lets you create both custodial and non-custodial wallets within
